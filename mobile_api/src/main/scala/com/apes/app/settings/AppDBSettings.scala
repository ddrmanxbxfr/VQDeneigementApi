...
package com.apes.app.settings

object AppDBSettings {
    final val DBAddress = "localhost"
    final val DBName = "apesdeneigement"
    final val ArrondissementDBCollection = "arrondissement"
}